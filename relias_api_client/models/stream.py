...
class Stream(object):
    ...
    def __init__(self, can_read=None, can_seek=None, can_timeout=None, can_write=None, length=None, position=None, read_timeout=None, write_timeout=None, _configuration=None):  # noqa: E501
